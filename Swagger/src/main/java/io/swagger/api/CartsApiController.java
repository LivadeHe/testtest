...
public class CartsApiController implements CartsApi {
    ...
    public ResponseEntity<Cart> cartsCartIdGet(@Parameter(in = ParameterIn.PATH, description = "Die ID des Warenkorbs", required=true, schema=@Schema()) @PathVariable("cartId") Integer cartId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Cart>(objectMapper.readValue("{\n  \"id\" : 0,\n  \"userId\" : 6,\n  \"items\" : [ {\n    \"quantity\" : 5,\n    \"productId\" : 1\n  }, {\n    \"quantity\" : 5,\n    \"productId\" : 1\n  } ]\n}", Cart.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<List<Cart>> cartsGet() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Cart>>(objectMapper.readValue("[ {\n  \"id\" : 0,\n  \"userId\" : 6,\n  \"items\" : [ {\n    \"quantity\" : 5,\n    \"productId\" : 1\n  }, {\n    \"quantity\" : 5,\n    \"productId\" : 1\n  } ]\n}, {\n  \"id\" : 0,\n  \"userId\" : 6,\n  \"items\" : [ {\n    \"quantity\" : 5,\n    \"productId\" : 1\n  }, {\n    \"quantity\" : 5,\n    \"productId\" : 1\n  } ]\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
        ...
        return new ResponseEntity<List<Cart>>(HttpStatus.NOT_IMPLEMENTED);
    }
